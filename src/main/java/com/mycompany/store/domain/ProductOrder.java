...
public class ProductOrder implements Serializable {
    ...
    public ProductOrder orders(Set<OrderItem> orderItems) {
        this.setOrders(orderItems);
        return this;
    }

    public ProductOrder addOrder(OrderItem orderItem) {
        this.orders.add(orderItem);
        orderItem.setOrder(this);
        return this;
    }

    public ProductOrder removeOrder(OrderItem orderItem) {
