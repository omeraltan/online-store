  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.orderItem.home.createOrEditLabel" data-cy="OrderItemCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.orderItem.quantity')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.orderItem.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.orderItem.status')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('storeApp.orderItem.product')}
                type="select"
              >
                <option value="" key="0" />
                {products
              ...
              <ValidatedField
                ...
                name="order"
                data-cy="order"
                label={translate('storeApp.orderItem.order')}
                type="select"
              >
                <option value="" key="0" />
                {productOrders
