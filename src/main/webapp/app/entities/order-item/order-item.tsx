      ...
      <h2 id="order-item-heading" data-cy="OrderItemHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="storeApp.orderItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {orderItemList && orderItemList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="storeApp.orderItem.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.orderItem.home.notFound">No Order Items found</Translate>
            </div>
          )
        )}
      </div>
