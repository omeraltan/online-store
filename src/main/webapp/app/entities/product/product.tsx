      ...
      <h2 id="product-heading" data-cy="ProductHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="storeApp.product.home.refreshListLabel">Refresh List</Translate>
          </Button>
          ...
          <Table responsive>
            <thead>
              <tr style={{ fontSize: 12 }}>
                ...
                <th className="hand" onClick={sort('beden')}>
                  <Translate contentKey="storeApp.product.beden">Beden</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{product.price}</td>
                  <td>
                    <Translate contentKey={`storeApp.Beden.${product.beden}`} />
                  </td>
                  <td>
                    {product.image ? (
                      <div>
