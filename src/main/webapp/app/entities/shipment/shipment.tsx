      ...
      <h2 id="shipment-heading" data-cy="ShipmentHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="storeApp.shipment.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {shipmentList && shipmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="storeApp.shipment.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.shipment.home.notFound">No Shipments found</Translate>
            </div>
          )
        )}
      </div>
