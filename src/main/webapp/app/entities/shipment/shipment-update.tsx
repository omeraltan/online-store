  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.shipment.home.createOrEditLabel" data-cy="ShipmentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.shipment.trackingCode')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.shipment.date')}
                id="shipment-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('storeApp.shipment.details')}
                id="shipment-details"
                name="details"
                data-cy="details"
                type="text"
              ...
              <ValidatedField
                ...
                name="invoice"
                data-cy="invoice"
                label={translate('storeApp.shipment.invoice')}
                type="select"
              >
                <option value="" key="0" />
                {invoices
