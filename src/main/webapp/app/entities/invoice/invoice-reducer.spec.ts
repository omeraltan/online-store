...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVOICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVOICE actions', async () => {
      const expectedActions = [
        {
