      ...
      <h2 id="invoice-heading" data-cy="InvoiceHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="storeApp.invoice.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {invoiceList && invoiceList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="storeApp.invoice.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.invoice.home.notFound">No Invoices found</Translate>
            </div>
          )
        )}
      </div>
