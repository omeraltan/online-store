...
import com.mycompany.store.domain.enumeration.Beden;
...
class ProductResourceIT {
    ...
    private static final Beden DEFAULT_BEDEN = Beden.S;
    private static final Beden UPDATED_BEDEN = Beden.M;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getBeden()).isEqualTo(DEFAULT_BEDEN);
    ...
    @Test
    @Transactional
    void checkBedenIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setBeden(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].beden").value(hasItem(DEFAULT_BEDEN.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.beden").value(DEFAULT_BEDEN.toString()))
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getBeden()).isEqualTo(UPDATED_BEDEN);
