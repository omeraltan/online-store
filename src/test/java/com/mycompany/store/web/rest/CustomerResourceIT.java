...
class CustomerResourceIT {
    ...
    private static final Gender UPDATED_GENDER = Gender.FMALE;

    private static final String DEFAULT_EMAIL = "h@&7R.F";
    private static final String UPDATED_EMAIL = "d@,F2W.;k\"";
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.firstName(UPDATED_FIRST_NAME).email(UPDATED_EMAIL).country(UPDATED_COUNTRY);
